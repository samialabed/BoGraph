...
from autorocks.experiments.gem5.cfgs import available_optimizer, available_params
...
if __name__ == "__main__":
    ...
    bench_cfg = gem5_benchmark_plan(cli_options.bench)
    env_cfg = gem5_env(benchmark=bench_cfg)
